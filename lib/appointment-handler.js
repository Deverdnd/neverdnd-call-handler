 ...
 */
function getSchedulingSystemPrompt(businessName, businessInfo, canSchedule, tone = 'professional', additionalInstructions = '') {
  // Tone descriptions
  const toneInstructions = {
    professional: 'Speak in a polished, business-like manner. Be courteous and formal.',
    friendly: 'Be warm and approachable. Use a conversational, welcoming tone.',
    enthusiastic: 'Be energetic and excited! Show enthusiasm in your responses.',
    calm: 'Speak in a soothing, reassuring manner. Keep responses calm and measured.'
  }
  
  const toneInstruction = toneInstructions[tone] || toneInstructions.professional
  
  const basePrompt = `You are an AI phone assistant for ${businessName}. 
...
` : ''}Your role is to be helpful and efficient while maintaining the specified tone.`
